...
<div id="map"></div>
<?php echo form_open(base_url('index.php/admin/editAttraction/'.$taId.'/'.$cityId),'class="form-signin"');?>
<div class="form-group">
    <label for="name">Attraction Name:</label>
    <input type="text" class="form-control" id="placeName" name="placeName" value="<?php echo $row->placeName;?>">
</div>
<div class="form-group">
    <label for="place_id">Place Id:</label>
    <input type="text" class="form-control" id="place_id" name="place_id" value="<?php echo $row->place_id;?>">
</div>
<div class="form-group">
    <label for="city">City ID:</label>
    <input type="text" class="form-control" id="cityId" name="cityId" value="<?php echo $row->city_id;?>">
</div>
<div class="form-group">
